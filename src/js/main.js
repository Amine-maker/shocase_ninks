...
window.addEventListener('DOMContentLoaded', function () {
  ...
  mm.add({
    ...
    const smoother = gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_5__.ScrollSmoother.create({
  ...
  text.forEach(el => {
    const splitWords = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_4__.SplitText(el, {
      type: 'lines'
    })
